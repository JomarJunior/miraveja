...
from MiravejaApi.Gallery.Application.RegisterImageMetadata import (
    RegisterImageMetadataCommand,
    RegisterImageMetadataHandler,
)
from MiravejaApi.Gallery.Application.RegisterGenerationMetadata import (
    RegisterGenerationMetadataCommand,
    RegisterGenerationMetadataHandler,
)
from MiravejaApi.Gallery.Domain.Enums import ImageRepositoryType
from MiravejaApi.Gallery.Domain.Exceptions import ImageMetadataUriAlreadyExistsException
from MiravejaApi.Gallery.Domain.Interfaces import IImageMetadataRepository
from MiravejaApi.Gallery.Domain.Models import ImageMetadata
from MiravejaApi.Shared.Events.Application.EventDispatcher import EventDispatcher
from MiravejaApi.Shared.Identifiers.Models import ImageMetadataId, VectorId
