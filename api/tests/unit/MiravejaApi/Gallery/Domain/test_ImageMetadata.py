...
from MiravejaApi.Gallery.Domain.Models import ImageMetadata, Size, GenerationMetadata
from MiravejaApi.Gallery.Domain.Enums import ImageRepositoryType
from MiravejaApi.Shared.Identifiers.Models import ImageMetadataId, MemberId, GenerationMetadataId, VectorId
...
class TestImageMetadata:
    ...
    def test_InitializeWithEmptySubtitle_ShouldRaiseValidationError(self):
        """Test that ImageMetadata raises validation error with empty subtitle."""
        with pytest.raises(ValidationError) as exc_info:
            self._create_minimal_image_metadata(subtitle="")
