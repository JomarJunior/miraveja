...
from MiravejaApi.Gallery.Domain.Enums import SamplerType, SchedulerType, TechniqueType, ImageRepositoryType
...
class TestSamplerType:
    ...
    def test_EnumValues_ShouldHaveCorrectStringValues(self):
        ...
        assert SamplerType.DPMPP_2M.value == "DPM++_2M"
        assert SamplerType.EULER_A.value == "Euler_a"
    ...
    def test_StrMethod_ShouldReturnValue(self):
        ...
        assert str(SamplerType.DPMPP_2M) == "DPM++_2M"
        assert str(SamplerType.EULER_A) == "Euler_a"
