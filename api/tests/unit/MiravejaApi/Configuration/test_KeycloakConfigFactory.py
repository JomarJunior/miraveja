...
from MiravejaApi.Configuration.Models import KeycloakConfigFactory
from MiravejaApi.Shared.Keycloak.Domain.Models import KeycloakConfig


class TestKeycloakConfigFactory:
    """Test cases for KeycloakConfigFactory factory class."""
    ...
    def test_FromEnvWithAllEnvironmentVariables_ShouldSetCorrectValues(self):
        ...
        config = KeycloakConfigFactory.FromEnv()
