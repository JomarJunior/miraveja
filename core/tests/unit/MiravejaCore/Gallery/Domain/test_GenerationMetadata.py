...
from MiravejaCore.Gallery.Domain.Models import GenerationMetadata, Size, LoraMetadata
...
class TestGenerationMetadata:
    ...
    def test_InitializeWithCompleteData_ShouldSetCorrectValues(self):
        ...
        seed = "123456"  # seed is now a string
    ...
    # Note: steps field no longer has positive integer validation in the model
